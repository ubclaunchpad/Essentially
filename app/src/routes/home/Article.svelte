<script lang="ts">
	...
	const generateSummary = async () => {
		...
		sumWords = countWords(summary);
		numWords = sumWords;
		// const summaryId = '11111111111';
		// const requestOptions = {
		// 	method: 'POST',
		// 	headers: { 'Content-Type': 'application/json' },
		// 	body: JSON.stringify({ content: submission, length: 1, summaryId: summaryId })
		// };

		// const summaryPath = await fetch(
		// 	'https://xi9bq76tv2.execute-api.us-west-2.amazonaws.com/prod/summaryRequest',
		// 	requestOptions
		// )
		// 	.then((res) => res.json())
		// 	.then((data) => {
		...
		// 				showSummary = true;
		// 				sumWords = countWords(data.summarized_text);
		// 			});
		// 		}
		// 	});
		// }, 3000);
